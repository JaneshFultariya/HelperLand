...
<body>
  <div class="header" id="topheader">
    ...
    <div class="text-center container mx-auto d-flex flex-row text-image-steps justify-content-center row grid-row" style="padding-top: 150px;">
      ...
      <div class="container">
        <div class="row text-image-above-blog">
          <div class="col-6 p-0 order-1">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nisi sapien, suscipit ut accumsan vitae,
              pulvinar ac libero.
      ...
      <div class="card-deck container mx-auto" style="margin-top: 50px;">
        <div class="extra-div card">
          <div class="card-body">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed fermentum metus pulvinar aliquet consequat.
              Praesent nec malesuada nibh.</p>
        ...
        <div class="extra-div card">
          <div class="card-body">
            ...
            <div class="box-text">
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed fermentum metus pulvinar aliquet
                consequat.
                Praesent nec malesuada nibh.</p>
              <p>Nullam et metus congue, auctor augue sit amet, consectetur tortor.</p>
            </div>
      ...
      <div id="get-news-letter">
        <div class="align-items-center" style="padding-top: 47.67px;">
          ...
          <div class="news-letter-news-letters-email-submit d-flex flex-column">
            <div class="news-letter-news-letters text-center text-up-news-letter">
